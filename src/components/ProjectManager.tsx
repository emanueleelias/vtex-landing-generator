        ...
        <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-6 pointer-events-none">
                ...
                >
                    ...
                    {/* Guardar actual */}
                    <div className="px-5 py-3 border-b border-black/5 dark:border-white/10 bg-teal-500/5 dark:bg-teal-500/10">
                        <div className="flex items-center gap-2">
                            <input
                                type="text"
                                value={saveName}
                                ...
                                className="flex-1 bg-white/60 dark:bg-black/20 border border-black/5 dark:border-white/10 rounded-lg px-3 py-2 text-sm text-slate-900 dark:text-white placeholder-slate-400 focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/30 transition-all backdrop-blur-sm shadow-inner"
                            />
                            <button
                                onClick={handleSave}
                                className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-teal-500 to-teal-500 text-teal-950 text-sm font-semibold shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all"
                            >
                                <Save size={14} />
                                Guardar
                            </button>
                    ...
                    <div className="flex-1 overflow-y-auto p-3 space-y-2">
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-3 p-3 rounded-xl border border-dashed border-black/15 dark:border-white/15 hover:border-teal-500/40 hover:bg-teal-500/5 transition-all group"
                        >
                            <div className="w-9 h-9 rounded-lg bg-black/5 dark:bg-white/5 group-hover:bg-teal-500/10 flex items-center justify-center transition-colors">
                                <FilePlus2 size={16} className="text-slate-400 group-hover:text-teal-500 transition-colors" />
                            </div>
                            <div className="text-left">
                                <p className="text-sm font-medium text-slate-600 dark:text-slate-300 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">Nuevo proyecto</p>
                            ...
                            >
                                ...
                                <div className="w-9 h-9 rounded-lg bg-black/5 dark:bg-white/5 flex items-center justify-center flex-shrink-0">
                                    {project.generationMode === 'landing' ? (
                                        <LayoutList size={16} className="text-teal-500" />
                                    ) : (
                                    ...
                                    {editingId === project.id ? (
                                        <div className="flex items-center gap-1.5">
                                            <input
                                                ...
                                                autoFocus
                                                className="flex-1 bg-white/80 dark:bg-black/30 border border-teal-500/50 rounded px-2 py-1 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-teal-500/30"
                                            />
                                        ...
                                        <>
                                            ...
                                            <div className="flex items-center gap-2 text-[10px] text-slate-400">
                                                ...
                                                <span>•</span>
                                                <span className={project.generationMode === 'landing' ? 'text-teal-400' : 'text-amber-400'}>
