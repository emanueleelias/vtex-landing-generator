...
import { Settings, Box, Unplug } from 'lucide-react'
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-5">
                ...
                <div className="space-y-3">
                    ...
                    {renderPropsFields(block, definition, handlePropChange)}
                </div>
            </div>
        </div>
    )
 ...
 */
function renderPropsFields(block, definition, handlePropChange) {
    const fields = []
