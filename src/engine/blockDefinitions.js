...
/**
 * Catálogo de definiciones de bloques disponibles.
 * Cada definición contiene la info para la UI y las funciones
 * que generan los nodos JSONC para desktop y mobile.
 */
const blockDefinitions = [
  {
    ...
    shared: true,
    generateNodes: (id, landingName, props, index) => {
...

  {
    ...
    shared: false,
    generateDesktopNodes: (id, landingName, props, index) => {
    ...
    generateMobileNodes: (id, landingName, props, index) => {
